...
return function (App $app) {
    ...
    $app->group('', function (RouteCollectorProxy $group) {
        ...
        $group->post('/verify', [VerifyController::class, 'resend'])->setName('resendVerification')->add(
    ...
    $app->group('', function (RouteCollectorProxy $guest) {
        ...
        $guest->post('/register', [AuthController::class, 'register'])->setName('register')->add(
            RateLimitMiddleware::class
        );
        $guest->post('/login/two-factor', [AuthController::class, 'twoFactorLogin'])->setName('twoFactorLogIn')->add(
            RateLimitMiddleware::class
        );
